...
if(isset($_POST['submit']))
{
    ...
    // print_r('<br>');
    // print_r('ID Quantidade: ' . $_POST['Quantidade']);
    // print_r('<br>');
    ...
    $result = mysqli_query($conexao, "INSERT INTO tb_produto(PRO_BARCODE,PRO_NOME,PRO_DESCRICAO,PRO_PRECO,PRO_CATEGORIA,PRO_TAMANHO,PRO_COR,PRO_MATERIAL,PRO_QUANTIDADE,PRO_FORNECEDOR,PRO_IMAGEM1,PRO_IMAGEM2,PRO_IMAGEM3,PRO_IMAGEM4,ID_FUNCIONARIO) 
    VALUES ('$barcode','$nome','$descricao','$preco','$categoria','$tamanho','$cor','$material','$quantidade','$fornecedor','$new_img1_name','$new_img2_name','$new_img3_name','$new_img4_name','$admin_id')");
    }
}
?>
<!DOCTYPE html>
                        ...
                        <div class="local">
                            ...
                            <div class="fields">
                                <div class="inputs">
                                    ...
                                    <input type="number" id="quantidade" name="quantidade" min="1" placeholder="1">
                                </div>
                                <div class="inputs">
